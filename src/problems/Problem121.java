...
public class Problem121 {
	...
	public static BigInteger solution() {
		problems.Problem183.Rational ans = new problems.Problem183.Rational(BigInteger.ZERO, BigInteger.ONE);
		for (int i = 0; i < Math.pow(2, turns); i++) {
			...
			if (isWinner(binary)) {
				...
				ans = ans.add(new problems.Problem183.Rational(over, under));
			}
		}
