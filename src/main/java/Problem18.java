...
public class Problem18 {
	...
	public static int solution() throws IOException {
		BufferedReader in = new BufferedReader(new FileReader("C:/Python27/Problem18.txt"));
...
//			System.out.println();
		...
		for (int i = 0; i < shortest.length; i++) {
			if (storste < shortest[shortest.length-1][i])
				storste = shortest[shortest.length-1][i];
		}
		return storste;
	}
}
